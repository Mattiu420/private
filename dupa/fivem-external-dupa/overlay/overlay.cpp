...
void i_overlay::menu()
{
	...
	ImGui::Begin(skCrypt("wasp hook"), nullptr, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse);
	{
		ImVec2 pos;
		...
		draw->AddText(ImVec2(pos.x + 10, pos.y + 2), ImColor(157, 176, 242), (skCrypt(("wasp hook"))));
